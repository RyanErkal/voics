			...
			<button
				...
				<span
					className={`flex-1 text-base-content ${
						isOpen ? "text-[#ff8ba0] font-semibold" : ""
					}`}>
...
const FeaturesAccordion = () => {
	...
	return (
		<section
			...
			id="features">
			<div className="px-8">
				<h2 className="font-extrabold text-3xl lg:text-5xl tracking-tight mb-6 md:mb-12 lg:mb-24">
				...
				<div className=" flex flex-col md:flex-row gap-12 md:gap-24">
					<div className="grid grid-cols-1 items-stretch gap-8 sm:gap-12 md:grid-cols-2 lg:gap-20">
						<ul className="w-full">
