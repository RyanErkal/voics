					...
					<div className="w-72 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
						<Link
							...
							<Image
								...
								className="py-4 xl:py-8 xl:w-full"
								width={200}
								height={200}
							/>
						</Link>

						<p className="mt-3 text-sm text-black text-opacity-75">
					...
					<div className="flex justify-center md:flex-col gap-2">
						<a
							...
							<svg
								...
								viewBox="0 0 24 24"
								fill="currentColor"
								className="hover:text-[#ff8ba0] cursor-pointer transition-all ease-in-out duration-300">
